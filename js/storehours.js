...
if (hourNow > 21) {
  greeting ='Sorry, the Fremont store is closed.';
} else if (hourNow >10) {
greeting = 'The Fremont store is open.';
//  } else if (hourNow > 0) {
...
var elgreeting = document.getElementById('storehours');

elgreeting.innerHTML = fremont;
